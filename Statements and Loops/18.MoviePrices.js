function ticketPrice([titleInput, dayInput]){

    let title = titleInput.toLowerCase();
...
console.log(ticketPrice(["casablanca", "Friday"]));
console.log(ticketPrice(["the godfather", "Monday"]));